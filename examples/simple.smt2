...
(assert (fp.lt a (fp #b0 #b11111111111 #b0000000000000000000000000000000000000000000000000000)))
(assert (fp.lt b (fp #b0 #b11111111111 #b0000000000000000000000000000000000000000000000000000)))

(assert (fp.lt sum (fp #b0 #b11111111111 #b0000000000000000000000000000000000000000000000000000)))
(assert (fp.gt sum c))
